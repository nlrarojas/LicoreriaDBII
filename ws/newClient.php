...
if( $conn ) {
    $procedure = "EXEC addUserCliente @nombre = ?, @apellidos = ?, @fechaNacimiento = ?, @username = ?, 
        @password = ?, @sucursal = ?";
